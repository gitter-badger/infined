        ...
        (function (infined) {
            ...
            (function (Application) {
                ...
                function registerServices(ngModule) {
                    _.each(infined.Services, function (Service) {
                        if (Service.ID) {
                ...
                function registerDirectives(ngModule) {
                    _.each(infined.Directives, function (Directive) {
                        if (Directive.ID) {
                ...
                function registerFilters(ngModule) {
                    _.each(infined.Filters, function (Filter) {
                ...
                function registerControllers(ngModule) {
                    _.each(infined.Controllers, function (Controller) {
                        if (Controller.ID) {
                ...
                function registerDialogs(Utilities, UiHelper) {
                    _.each(infined.Controllers, function (Controller) {
                        if (Controller === infined.Controllers.BaseDialogController) {
                            return;
                        }
                        if (Utilities.derivesFrom(Controller, infined.Controllers.BaseDialogController)) {
                ...
                function angular_configure($stateProvider, $urlRouterProvider, $provide, $httpProvider, $compileProvider) {
                    ...
                    $httpProvider.interceptors.push(infined.Services.HttpInterceptor.ID);
                    infined.RouteConfig.setupRoutes($stateProvider, $urlRouterProvider);
                    if (localStorage.getItem("ENABLE_MOCK_HTTP_CALLS") === "true") {
                        infined.Services.MockHttpApis.setupMockHttpDelay($provide);
                    }
                }
                ;
                ...
                function window_onerror(message, uri, lineNumber, columnNumber) {
                    ...
                    try {
                        UiHelper = angular.element(document.body).injector().get(infined.Services.UiHelper.ID);
                    ...
                    try {
                        Logger = angular.element(document.body).injector().get(infined.Services.Logger.ID);
            ...
            })(Application = infined.Application || (infined.Application = {}));
        })(infined = identy.infined || (identy.infined = {}));
    })(identy = org.identy || (org.identy = {}));
})(org || (org = {}));
var org;
(function (org) {
    var identy;
    (function (identy) {
        ...
        (function (infined) {
            var RouteConfig = (function () {
                ...
                RouteConfig.setupRoutes = function ($stateProvider, $urlRouterProvider) {
                    $stateProvider.state("app", {
                        ...
                        controller: infined.Controllers.MenuController.ID
                    });
                    ...
                    $stateProvider.state("app.category", {
                        ...
                        views: {
                            "menuContent": {
                                ...
                                controller: infined.Controllers.CategoryController.ID
                            }
                        }
                    });
                    $stateProvider.state("app.onboarding-splash", {
                        ...
                        views: {
                            "menuContent": {
                                ...
                                controller: infined.Controllers.OnboardingSplashController.ID
                            }
                        }
                    });
                    $stateProvider.state("app.onboarding-register", {
                        ...
                        views: {
                            "menuContent": {
                                ...
                                controller: infined.Controllers.OnboardingRegisterController.ID
                            }
                        }
                    });
                    $stateProvider.state("app.onboarding-share", {
                        ...
                        views: {
                            "menuContent": {
                                ...
                                controller: infined.Controllers.OnboardingShareController.ID
                            }
                        }
                    });
                    $stateProvider.state("app.settings-list", {
                        ...
                        views: {
                            "menuContent": {
                                ...
                                controller: infined.Controllers.SettingsListController.ID
                            }
                        }
                    });
                    $stateProvider.state("app.cloud-sync", {
                        ...
                        views: {
                            "menuContent": {
                                ...
                                controller: infined.Controllers.CloudSyncController.ID
                            }
                        }
                    });
                    $stateProvider.state("app.configure-pin", {
                        ...
                        views: {
                            "menuContent": {
                                ...
                                controller: infined.Controllers.ConfigurePinController.ID
                            }
                        }
                    });
                    $stateProvider.state("app.developer", {
                        ...
                        views: {
                            "menuContent": {
                                ...
                                controller: infined.Controllers.DeveloperController.ID
                            }
                        }
                    });
                    $stateProvider.state("app.logs", {
                        ...
                        views: {
                            "menuContent": {
                                ...
                                controller: infined.Controllers.LogsController.ID
                            }
                        }
                    });
                    $stateProvider.state("app.log-entry", {
                        ...
                        views: {
                            "menuContent": {
                                ...
                                controller: infined.Controllers.LogEntryController.ID
                            }
                        }
                    });
                    $stateProvider.state("app.about", {
                        ...
                        views: {
                            "menuContent": {
                                ...
                                controller: infined.Controllers.AboutController.ID
                            }
                        }
                    });
            ...
            infined.RouteConfig = RouteConfig;
        })(infined = identy.infined || (identy.infined = {}));
    })(identy = org.identy || (org.identy = {}));
})(org || (org = {}));
var org;
(function (org) {
    ...
    (function (identy) {
        ...
        (function (infined) {
            ...
            })(Controllers = infined.Controllers || (infined.Controllers = {}));
        })(infined = identy.infined || (identy.infined = {}));
    })(identy = org.identy || (org.identy = {}));
})(org || (org = {}));
...
(function (org) {
    ...
    (function (identy) {
        ...
        (function (infined) {
            ...
            })(Directives = infined.Directives || (infined.Directives = {}));
        })(infined = identy.infined || (identy.infined = {}));
    })(identy = org.identy || (org.identy = {}));
})(org || (org = {}));
/**
            ...
            (function (Controllers) {
                var CategoryController = (function (_super) {
                    ...
                    function CategoryController($scope, $stateParams) {
                        _super.call(this, $scope, infined.ViewModels.CategoryViewModel);
            ...
            (function (Controllers) {
                var MenuController = (function (_super) {
                    ...
                    function MenuController($scope, $location, $http, Utilities, UiHelper, Preferences) {
                        _super.call(this, $scope, infined.ViewModels.MenuViewModel);
                    ...
                    Object.defineProperty(MenuController, "$inject", {
                        get: function () {
                            return ["$scope", "$location", "$http", infined.Services.Utilities.ID, infined.Services.UiHelper.ID, infined.Services.Preferences.ID];
                        },
                        enumerable: true,
                        configurable: true
                    });
            ...
            (function (Controllers) {
                var PinEntryController = (function (_super) {
                    ...
                    function PinEntryController($scope, Utilities, Preferences, UiHelper) {
                        _super.call(this, $scope, infined.ViewModels.PinEntryViewModel, PinEntryController.ID);
                        this.Utilities = Utilities;
                        this.Preferences = Preferences;
                        this.UiHelper = UiHelper;
                    }
                    Object.defineProperty(PinEntryController, "$inject", {
                        get: function () {
                            return ["$scope", infined.Services.Utilities.ID, infined.Services.Preferences.ID, infined.Services.UiHelper.ID];
                        },
                        enumerable: true,
                        configurable: true
                    });
                    ...
                    PinEntryController.prototype.validatePin = function () {
                        if (this.viewModel.pinToMatch) {
                            if (this.viewModel.pin === this.viewModel.pinToMatch) {
                                this.close(new infined.Models.PinEntryDialogResultModel(true, false, this.viewModel.pin));
                            }
                            else {
                                this.viewModel.pin = "";
                            ...
                            this.close(new infined.Models.PinEntryDialogResultModel(null, false, this.viewModel.pin));
                        }
                    };
                    ...
                    PinEntryController.prototype.back_click = function () {
                        this.close(new infined.Models.PinEntryDialogResultModel(null, true, null));
                    };
            ...
            (function (Controllers) {
                var ReorderCategoriesController = (function (_super) {
                    ...
                    function ReorderCategoriesController($scope, Utilities, Preferences, UiHelper) {
                        _super.call(this, $scope, infined.ViewModels.ReorderCategoriesViewModel, ReorderCategoriesController.ID);
                        this.Utilities = Utilities;
                        this.Preferences = Preferences;
                    }
            ...
            (function (Controllers) {
                var OnboardingRegisterController = (function (_super) {
                    ...
                    function OnboardingRegisterController($scope, $location, $ionicHistory, Utilities, UiHelper, Preferences) {
                        _super.call(this, $scope, infined.ViewModels.OnboardingRegisterViewModel);
                        this.$location = $location;
                    ...
                    Object.defineProperty(OnboardingRegisterController, "$inject", {
                        get: function () {
                            return ["$scope", "$location", "$ionicHistory", infined.Services.Utilities.ID, infined.Services.UiHelper.ID, infined.Services.Preferences.ID];
                        },
                        enumerable: true,
                        configurable: true
                    });
            ...
            (function (Controllers) {
                var OnboardingShareController = (function (_super) {
                    ...
                    function OnboardingShareController($scope, $location, $ionicHistory, Utilities, UiHelper, Preferences) {
                        _super.call(this, $scope, infined.ViewModels.EmptyViewModel);
                        this.$location = $location;
                        this.$ionicHistory = $ionicHistory;
                        this.Utilities = Utilities;
                        this.UiHelper = UiHelper;
            ...
            (function (Controllers) {
                var OnboardingSplashController = (function (_super) {
                    ...
                    Object.defineProperty(OnboardingSplashController, "$inject", {
                        get: function () {
                            return ["$scope", "$location", "$ionicHistory", infined.Services.Utilities.ID, infined.Services.Preferences.ID];
                        },
                        enumerable: true,
                        configurable: true
                    });
            ...
            (function (Controllers) {
                var AboutController = (function (_super) {
                    ...
                    function AboutController($scope, $ionicHistory, Utilities, Preferences, UiHelper, versionInfo) {
                        _super.call(this, $scope, infined.ViewModels.AboutViewModel);
                        this.$ionicHistory = $ionicHistory;
                        this.Utilities = Utilities;
                        this.Preferences = Preferences;
                        this.UiHelper = UiHelper;
                    ...
                    Object.defineProperty(AboutController, "$inject", {
                        get: function () {
                            return ["$scope", "$ionicHistory", infined.Services.Utilities.ID, infined.Services.Preferences.ID, infined.Services.UiHelper.ID, "versionInfo"];
                        },
                        enumerable: true,
                        configurable: true
                    });
            ...
            (function (Controllers) {
                var CloudSyncController = (function (_super) {
                    ...
                    function CloudSyncController($scope, $ionicHistory) {
                        _super.call(this, $scope, infined.ViewModels.CloudSyncViewModel);
                        this.$ionicHistory = $ionicHistory;
            ...
            (function (Controllers) {
                var ConfigurePinController = (function (_super) {
                    ...
                    function ConfigurePinController($scope, UiHelper, Preferences) {
                        _super.call(this, $scope, infined.ViewModels.ConfigurePinViewModel);
                        this.UiHelper = UiHelper;
                        this.Preferences = Preferences;
                    }
                    Object.defineProperty(ConfigurePinController, "$inject", {
                        get: function () {
                            return ["$scope", infined.Services.UiHelper.ID, infined.Services.Preferences.ID];
                        },
                        enumerable: true,
                        configurable: true
                    });
                    ...
                    ConfigurePinController.prototype.setPin_click = function () {
                        var _this = this;
                        var options, model;
                        model = new infined.Models.PinEntryDialogModel("Enter a value for your new PIN", null, true);
                        options = new infined.Models.DialogOptions(model);
                    ...
                    ConfigurePinController.prototype.changePin_click = function () {
                        var _this = this;
                        var options, model;
                        model = new infined.Models.PinEntryDialogModel("Enter your current PIN", this.Preferences.pin, true);
                        options = new infined.Models.DialogOptions(model);
                        this.UiHelper.showDialog(Controllers.PinEntryController.ID, options).then(function (result1) {
                            if (result1.matches) {
            ...
            (function (Controllers) {
                var DeveloperController = (function (_super) {
                    ...
                    function DeveloperController($scope, $http, Utilities, UiHelper, FileUtilities, Logger, Preferences) {
                        _super.call(this, $scope, infined.ViewModels.DeveloperViewModel);
                        this.$http = $http;
                        this.Utilities = Utilities;
                        this.UiHelper = UiHelper;
                    ...
                    Object.defineProperty(DeveloperController, "$inject", {
                        get: function () {
                            return ["$scope", "$http", infined.Services.Utilities.ID, infined.Services.UiHelper.ID, infined.Services.FileUtilities.ID, infined.Services.Logger.ID, infined.Services.Preferences.ID];
                        },
                        enumerable: true,
                        configurable: true
                    });
                    ...
                    DeveloperController.prototype.showPinEntry_click = function () {
                        var _this = this;
                        var options, model;
                        model = new infined.Models.PinEntryDialogModel("Testing new PIN entry", null, true);
                        options = new infined.Models.DialogOptions(model);
                        this.UiHelper.showDialog(Controllers.PinEntryController.ID, options).then(function (result) {
                    ...
                    DeveloperController.prototype.showPinEntry1234_click = function () {
                        var _this = this;
                        var options, model;
                        model = new infined.Models.PinEntryDialogModel("Testing PIN matching (1234)", "1234", true);
                        options = new infined.Models.DialogOptions(model);
                        this.UiHelper.showDialog(Controllers.PinEntryController.ID, options).then(function (result) {
                            _this.UiHelper.alert("Cancelled: " + result.cancelled + " PIN matches: " + result.matches + " PIN entered: " + result.pin);
                        });
            ...
            (function (Controllers) {
                var LogEntryController = (function (_super) {
                    ...
                    function LogEntryController($scope, $stateParams, Logger, UiHelper, Utilities, versionInfo) {
                        _super.call(this, $scope, infined.ViewModels.LogEntryViewModel);
                        this.$stateParams = $stateParams;
                        this.Logger = Logger;
                        this.UiHelper = UiHelper;
                        this.Utilities = Utilities;
                    ...
                    Object.defineProperty(LogEntryController, "$inject", {
                        get: function () {
                            return ["$scope", "$stateParams", infined.Services.Logger.ID, infined.Services.UiHelper.ID, infined.Services.Utilities.ID, "versionInfo"];
                        },
                        enumerable: true,
                        configurable: true
                    });
            ...
            (function (Controllers) {
                var LogsController = (function (_super) {
                    ...
                    function LogsController($scope, Logger, Utilities, UiHelper) {
                        _super.call(this, $scope, infined.ViewModels.LogsViewModel);
                        this.Logger = Logger;
                        this.Utilities = Utilities;
                        this.UiHelper = UiHelper;
                    }
                    Object.defineProperty(LogsController, "$inject", {
                        get: function () {
                            return ["$scope", infined.Services.Logger.ID, infined.Services.Utilities.ID, infined.Services.UiHelper.ID];
                        },
                        enumerable: true,
                        configurable: true
                    });
                    ...
                    LogsController.prototype.getLogs_success = function (logEntries) {
                        ...
                        logEntries.forEach(function (logEntry) {
                            ...
                            viewModel = new infined.ViewModels.LogEntryViewModel();
            ...
            (function (Controllers) {
                var SettingsListController = (function (_super) {
                    ...
                    function SettingsListController($scope, Utilities, Preferences) {
                        _super.call(this, $scope, infined.ViewModels.SettingsListViewModel);
                        this.Utilities = Utilities;
                        this.Preferences = Preferences;
                    }
                    Object.defineProperty(SettingsListController, "$inject", {
                        get: function () {
                            return ["$scope", infined.Services.Utilities.ID, infined.Services.Preferences.ID];
                        },
                        enumerable: true,
                        configurable: true
                    });
...
(function (org) {
    ...
    (function (identy) {
        ...
        (function (infined) {
            ...
            })(Filters = infined.Filters || (infined.Filters = {}));
        })(infined = identy.infined || (identy.infined = {}));
    })(identy = org.identy || (org.identy = {}));
})(org || (org = {}));
var org;
(function (org) {
    ...
    (function (identy) {
        ...
        (function (infined) {
            ...
            })(Models = infined.Models || (infined.Models = {}));
        })(infined = identy.infined || (identy.infined = {}));
    })(identy = org.identy || (org.identy = {}));
})(org || (org = {}));
var org;
...
(function (org) {
    ...
    (function (identy) {
        ...
        (function (infined) {
            ...
            })(Services = infined.Services || (infined.Services = {}));
        })(infined = identy.infined || (identy.infined = {}));
    })(identy = org.identy || (org.identy = {}));
})(org || (org = {}));
var org;
            ...
            (function (Services) {
                var Logger = (function () {
                    ...
                    Logger.prototype.logWindowError = function (message, uri, lineNumber, colNumber) {
                        var logEntry;
                        logEntry = new infined.Models.LogEntry();
                ...
                var UiHelper = (function () {
                    ...
                    UiHelper.prototype.prompt = function (message, title, buttonLabels, defaultText) {
                        ...
                        callback = function (promptResult) {
                            ...
                            promiseResult = new infined.Models.KeyValuePair(buttonText, promptResult.input1);
                    ...
                    UiHelper.prototype.showDialog = function (dialogId, options) {
                        ...
                        if (!options) {
                            options = new infined.Models.DialogOptions();
                        }
                    ...
                    UiHelper.prototype.showPinEntryAfterResume = function () {
                        ...
                        if (this.Preferences.pin && this.Preferences.lastPausedAt != null && this.Preferences.lastPausedAt.isValid()) {
                            ...
                            if (resumedAt.diff(this.Preferences.lastPausedAt, "minutes") > this.Preferences.requirePinThreshold) {
                                model = new infined.Models.PinEntryDialogModel("PIN Required", this.Preferences.pin, false);
                                options = new infined.Models.DialogOptions(model);
                                options.backdropClickToClose = false;
                                options.hardwareBackButtonClose = false;
                                options.showBackground = false;
                                this.showDialog(infined.Controllers.PinEntryController.ID, options).then(function (result) {
                                    q.resolve();
                                });
                            }
                            else {
            ...
            (function (Services) {
                var Utilities = (function () {
                    ...
                    Object.defineProperty(Utilities.prototype, "categories", {
                        get: function () {
                            var categories = [
                                new infined.ViewModels.CategoryItemViewModel("Category 1", "#/app/category/1", "ios-pricetags-outline", 0),
                                new infined.ViewModels.CategoryItemViewModel("Category 2", "#/app/category/2", "ios-pricetags-outline", 1),
                                new infined.ViewModels.CategoryItemViewModel("Category 3", "#/app/category/3", "ios-pricetags-outline", 2),
                                new infined.ViewModels.CategoryItemViewModel("Category 4", "#/app/category/4", "ios-pricetags-outline", 3)
                            ];
...
(function (org) {
    ...
    (function (identy) {
        ...
        (function (infined) {
            ...
            })(ViewModels = infined.ViewModels || (infined.ViewModels = {}));
        })(infined = identy.infined || (identy.infined = {}));
    })(identy = org.identy || (org.identy = {}));
})(org || (org = {}));
var org;
